...
class NewsTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.newsTextView.text = newsTexts[indexPath.row]
        cell.newsImageView.image = UIImage(named: newsImages[indexPath.row])
        cell.likeImageView.image = #imageLiteral(resourceName: "notLiked")
        cell.commentImageView.image = #imageLiteral(resourceName: "comment")
        cell.shareImageView.image = #imageLiteral(resourceName: "share")
